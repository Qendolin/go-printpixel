/* fast-poly2tri - v1.0
  ...
  Modified at some points for easier usage by Qendolin.
...
extern "C"
{
	...
	internal_static umm MPE_PolyMemoryRequired(u32 MaxPointCount);

	internal_static void MPE_PolyInitContext(MPEPolyContext *PolyContext, void *Memory, u32 MaxPointCount);

	internal_static MPEPolyPoint *MPE_PolyPushPoint(MPEPolyContext *PolyContext);

	internal_static MPEPolyPoint *MPE_PolyPushPointArray(MPEPolyContext *PolyContext, u32 Count);

	internal_static void MPE_PolyAddEdge(MPEPolyContext *PolyContext);

	internal_static void MPE_PolyTriangulate(MPEPolyContext *PolyContext);
...
internal_static
	u8 *
	MPE_PolyPushRaw(MPEPolyAllocator *Allocator, umm Size);
...
internal_static
	uxx
	MPE_PolyOrient2D(MPEPolyPoint *PointA, MPEPolyPoint *PointB, MPEPolyPoint *PointC)
{
	uxx Result;
...
internal_static
	bxx
	MPE_PolyInScanArea(MPEPolyPoint *PointA, MPEPolyPoint *PointB, MPEPolyPoint *PointC, MPEPolyPoint *PointD)
{
...
internal_static MPE_INLINE
	bxx
	MPE_PolyContainsPoint(MPEPolyTriangle *Triangle, MPEPolyPoint *Point)
{
	MPE_Assert(Point);
...
internal_static MPE_INLINE
	bxx
	MPE_PolyContainsPoints(MPEPolyTriangle *Triangle, MPEPolyPoint *Point, MPEPolyPoint *OtherPoint)
{
	bxx Result = MPE_PolyContainsPoint(Triangle, Point) && MPE_PolyContainsPoint(Triangle, OtherPoint);
	return Result;
}

internal_static void MPE_PolySwapNeighbors(MPEPolyTriangle *Triangle, MPEPolyTriangle *OldNeighbor, MPEPolyTriangle *NewNeighbor)
{
...
internal_static void MPE_PolyMarkNeighborTri(MPEPolyTriangle *Triangle, MPEPolyTriangle *Neighbor)
{
...
internal_static MPE_INLINE void MPE_ClearDelunayEdges(MPEPolyTriangle *Triangle)
{
...
internal_static
	MPEPolyPoint *
	MPE_PointCW(MPEPolyTriangle *Triangle, MPEPolyPoint *Point, i32 *PointIndex)
{
	MPEPolyPoint *Result;
...
internal_static
	MPEPolyTriangle *
	MPE_NeighborCCW(MPEPolyTriangle *Triangle, MPEPolyPoint *Point)
{
...
internal_static void MPE_SetAdjacentEdges(MPEPolyTriangle *Triangle, MPEPolyPoint *Point, MPEPolyEdges Edges, bxx Clockwise)
{
	uxx Mask;
	uxx NewFlags;
	if (Point == Triangle->Points[0])
...
internal_static
	uxx
	MPE_GetConstrainedEdgeCW(MPEPolyTriangle *Triangle, MPEPolyPoint *Point)
{
	uxx Result;
	if (Point == Triangle->Points[0])
	{
...
internal_static MPE_INLINE
	MPEPolyTriangle *
	MPE_PolyNeighborAcross(MPEPolyTriangle *Triangle, MPEPolyPoint *OppositePoint)
{
	MPEPolyTriangle *Result;
...
internal_static MPE_INLINE void MPE_PolyLegalizePoint(MPEPolyTriangle *Triangle, MPEPolyPoint *Point)
{
...
internal_static
	i32
	MPE_PolyPointIndex(MPEPolyTriangle *Triangle, MPEPolyPoint *Point)
{
	i32 Result;
	if (Point == Triangle->Points[0])
	{
...
internal_static
	i32
	MPE_EdgeIndex(MPEPolyTriangle *Triangle, MPEPolyPoint *P1, MPEPolyPoint *P2)
{
	i32 Result = -1;
...
internal_static MPE_INLINE void MPE_PolyMarkConstrainedEdgeIndex(MPEPolyTriangle *Triangle, i32 Index)
{
	MPE_Assert(Index >= 0);
	Triangle->Flags |= (uxx)MPEPolyTriFlag_ConstrainedEdge0 << (u32)Index;
}

internal_static MPE_INLINE void MPE_PolyMarkDelaunayEdge(MPEPolyTriangle *Triangle, i32 Index)
{
	MPE_Assert(Index >= 0);
	Triangle->Flags |= (uxx)MPEPolyTriFlag_DelaunayEdge0 << (u32)Index;
}

internal_static void MPE_PolyMarkConstrainedEdgePoints(MPEPolyTriangle *Triangle, MPEPolyPoint *Point, MPEPolyPoint *OtherPoint)
{
...
internal_static MPE_INLINE void MPE_PolyMarkConstrainedEdge(MPEPolyTriangle *Triangle, MPEPolyEdge *Edge)
{
...
internal_static MPE_INLINE
	MPEPolyNode *
	MPE_PolyNode(MPEPolyContext *PolyContext, MPEPolyPoint *Point, MPEPolyTriangle *Triangle)
{
...
internal_static
	MPEPolyPoint *
	MPE_PolyPushPoint(MPEPolyContext *PolyContext)
{
...
internal_static
	MPEPolyPoint *
	MPE_PolyPushPointArray(MPEPolyContext *PolyContext, u32 Count)
{
...
internal_static MPE_INLINE
	MPEPolyTriangle *
	MPE_PushTriangle(MPEPolyContext *PolyContext, MPEPolyPoint *A, MPEPolyPoint *B, MPEPolyPoint *C)
{
...
internal_static MPE_INLINE
	MPEPolyNode *
	MPE_LocatePoint(MPEPolyContext *PolyContext, MPEPolyPoint *Point)
{
...
internal_static
	bxx
	MPE_IsEdgeSideOfTriangle(MPEPolyTriangle *Triangle, MPEPolyPoint *EdgeP, MPEPolyPoint *EdgeQ)
{
...
internal_static
	bxx
	MPE_AngleExceeds90Degrees(MPEPolyPoint *Origin, MPEPolyPoint *PointA, MPEPolyPoint *PointB)
{
...
internal_static
	bxx
	MPE_AngleExceedsPlus90DegreesOrIsNegative(MPEPolyPoint *Origin, MPEPolyPoint *PointA, MPEPolyPoint *PointB)
{
	poly_float AX = PointA->X - Origin->X;
	poly_float AY = PointA->Y - Origin->Y;
	poly_float BX = PointB->X - Origin->X;
...
internal_static
	bxx
	MPE_LargeHole_DontFill(MPEPolyNode *Node)
{
	bxx Result;
...
internal_static MPE_INLINE
	bxx
	MPE_PolyShouldFillBasin(MPEPolyNode *Node)
{
...
internal_static
	bxx
	MPE_PolyInCircle(MPEPolyPoint *PointA, MPEPolyPoint *PointB, MPEPolyPoint *pc, MPEPolyPoint *pd)
{
	bxx Result;
...
/**
  ...
  *       n4                    n4
  */
internal_static void MPE_PolyRotateTrianglePair(MPEPolyTriangle *Triangle, MPEPolyPoint *Point, i32 PointIndex, MPEPolyTriangle *OtherTriangle,
...
internal_static
	bxx
	MPE_PolyIsShallow(MPEPolyContext *PolyContext, MPEPolyNode *Node)
{
	poly_float Height;
...
internal_static
	bxx
	MPE_PolyLegalize(MPEPolyContext *PolyContext, MPEPolyTriangle *Triangle);

internal_static void MPE_PolyMapTriangleToNodes(MPEPolyContext *PolyContext, MPEPolyTriangle *Triangle);

internal_static void MPE_PolyFill(MPEPolyContext *PolyContext, MPEPolyNode *Node)
{
...
internal_static void MPE_FillBasinReq(MPEPolyContext *PolyContext, MPEPolyNode *Node)
{
...
internal_static void MPE_FillBasin(MPEPolyContext *PolyContext, MPEPolyNode *Node)
{
...
internal_static void MPE_FillRightConcaveEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node);

internal_static void MPE_FillRightConvexEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node);

internal_static void MPE_FillLeftBelowEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node);

internal_static void MPE_FillLeftConcaveEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node);

internal_static void MPE_FillLeftConvexEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node);

internal_static void MPE_FillRightBelowEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node)
{
...
internal_static void MPE_FillRightAboveEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node)
{
...
internal_static void MPE_FillLeftAboveEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node)
{
...
internal_static void MPE_FillEdgeEvent(MPEPolyContext *PolyContext, MPEPolyEdge *Edge, MPEPolyNode *Node)
{
...
internal_static
	MPEPolyTriangle *
	MPE_NextFlipTriangle(MPEPolyContext *PolyContext, uxx Orientation, MPEPolyTriangle *Triangle,
...
internal_static MPE_INLINE
	i32
	MPE_NextFlipPoint(MPEPolyPoint *EdgeP, MPEPolyPoint *EdgeQ, MPEPolyPoint *OtherPoint, i32 OtherPointIndex)
{
...
internal_static void MPE_FlipScanEdgeEvent(MPEPolyContext *PolyContext, MPEPolyPoint *EdgeP, MPEPolyPoint *EdgeQ, i32 EdgeQIndex,
										   MPEPolyTriangle *FlipTriangle, MPEPolyTriangle *Triangle, i32 PointIndex);

internal_static void MPE_EdgeEventPoints(MPEPolyContext *PolyContext, MPEPolyPoint *EdgeP, MPEPolyPoint *EdgeQ, i32 EdgeQIndex,
										 MPEPolyTriangle *Triangle, MPEPolyPoint *Point, i32 PointIndex);

internal_static void MPE_FlipEdgeEvent(MPEPolyContext *PolyContext, MPEPolyPoint *EdgeP, MPEPolyPoint *EdgeQ, i32 EdgeQIndex, MPEPolyTriangle *Triangle,
...
internal_static void MPE_PolyFinalizeTriangles(MPEPolyContext *PolyContext, MPEPolyTriangle *StartTriangle)
{
...
internal_static MPE_INLINE void MPE_PolyAddHole(MPEPolyContext *PolyContext)
{
	MPE_PolyAddEdge(PolyContext);
}

internal_static MPE_INLINE void MPE_PolyAddPoints(MPEPolyContext *PolyContext, MPEPolyPoint *Points, u32 PointCount)
{
	for (uxx PointIndex = 0; PointIndex < PointCount; ++PointIndex)
	{
...
internal_static void MPE_PolySort(MPEPolyPoint **Points, MPEPolyPoint **Temp, u32 Count)
{
	MPE_Assert(Count);
	if (Count <= 1)
	{
...
internal_static
	i32
	MPE_PolySortCompare(MPEPolyPoint **A, MPEPolyPoint **B)
{
	i32 Result;
	if ((*A)->Y < (*B)->Y)
	{
...
internal_static void
MPE_PolyInitContext(MPEPolyContext *PolyContext, void *Memory, u32 MaxPointCount)
{
...
internal_static
	umm
	MPE_PolyMemoryRequired(u32 MaxPointCount)
{
